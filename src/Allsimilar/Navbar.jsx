...
const Navbar = () => {
  const { handlesignupauth, handleloginauth,cartno } = React.useContext(Authcontext);
  ...
  async function handleSignup() {
    try {
      let res = await fetch("https://backend-4-ex8z.onrender.com/user/signup", {
        method: "POST",
  ...
  async function handleLogin() {
    try {
      let res = await fetch("https://backend-4-ex8z.onrender.com/user/login", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
